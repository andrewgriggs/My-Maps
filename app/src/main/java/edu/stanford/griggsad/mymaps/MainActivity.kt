package edu.stanford.griggsad.mymaps
...
import edu.stanford.griggsad.mymaps.models.DisplayMapActivity
import edu.stanford.griggsad.mymaps.models.Place
import edu.stanford.griggsad.mymaps.models.UserMap
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapAdapter = MapsAdapter(this, userMaps, object: MapsAdapter.OnClickListener {
            override fun onItemClick(position: Int) {
                ...
                // when user taps on view in RV, navigate to next activity
